...
The **SOC Detection Summary** workbook provides a centralized visual summary of alert activity generated by Sentinel Analytics Rules.

**Workspace:** law-sec-ops
**Resource Group:** rg-shared-services
**Title:** SOC Detection Summary

### Visuals Included
- Alert count by rule name and severity
- Time series chart of alert volume
- MITRE tactic breakdown (based on rule mappings)

### How to View in Sentinel
  1. Open **Microsoft Sentinel → Workbooks**
  2. Select the law-sec-ops workspace
  3. Locate and open **SOC Detection Summary**

This workbook supports SOC teams by surfacing detection patterns, helping prioritize investigations, and validating Analytics Rule coverage across Zero Trust controls.

  To customize visuals, edit the .json file at:
  sentinel/workbooks/soc-detection-summary.workbook.json
  (Coming soon: automated deployment via IaC)